...
<?php
function swapThemByVal($num1, $num2) {
     $temp = $num1;
      $num1 = $num2;
      $num2 = $temp;
   }
   function swapThemByRef(&$num1, &$num2) {
    $temp = $num1;
      $num1 = $num2;
      $num2 = $temp;
   }
function main() {
      $i = 10; $j = 20;
      swapThemByVal($i, $j);
     echo "$i $j <br>";    // displays 10  20
      swapThemByRef($i, $j);
       echo "$i $j <br>";     // displays 20  10     
   }
main(); 
...
echo square(4.0); 
 ...
 echo "<br>Return type declarations<br>";
 class C {}
